"""Sync the current official Gazette issues into private R2 storage."""
...
from legalai_ingestion.connectors.documents_gov_lk_gazettes import discover_gazettes
...
def main() -> int:
    ...
    summary = store_documents(discover_gazettes(), store=store, download_pdf=download_pdf,
                              pipeline_version="0.6.0", minimum_download_interval_seconds=0.25)
    print(f"Gazette sync complete: {summary.checked} checked; {summary.pdfs_uploaded} PDFs uploaded; "
