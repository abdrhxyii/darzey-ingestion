"""Sync the current official Acts listing into private R2 storage."""
...
from legalai_ingestion.connectors.documents_gov_lk_acts import discover_acts
...
def main() -> int:
    ...
    summary = store_documents(
        ...
        minimum_download_interval_seconds=0.25,
    )
    print(
        f"Acts sync complete: {summary.checked} checked; {summary.pdfs_uploaded} PDFs "
